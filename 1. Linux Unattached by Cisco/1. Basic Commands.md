...
**DAY 2**
![](../Screenshots/Linux-file-type.png)
 - from left to right 

> In the listing files , there are total 10 characters. 
> First one is showing the **file type.** 

> Next nine characters are **[[5. Permissions]]** - how certain users can access a file. 
...
> Next to user owner, there is **[[../Misc/Group]] owner**. which group owns the file
...
---
[[../Misc/Cyber Security/Linux/Linux-Commands]]
